    ...
    ERC20("XEN Crypto", "XEN")
{
     ...
     */
    function claimRank(uint256 term) external override {
     ...
     */
    function claimMintReward() external override {
     ...
     */
    function stake(uint256 amount, uint256 term) external override {
